...
export default function Nav({ show }) {
  ...
  const activeLink =
    inactiveLink + " bg-highlight text-black rounded-lg p-1 pr-5";
  ...
  console.log("show is: ", show.toString());
  return (
    <aside
      className={
        (show ? "left-0" : "-left-full") +
        " top-0 text-gray-500 p-4 fixed w-full h-full bg-bgGray md:static md:w-auto transition-all"
      }
    >
